...
Prism Launcher is a cross-platform Minecraft launcher. It is a fork of MultiMC and is not endorsed by MultiMC.
...
[Prism Launcher Official Website](https://prismlauncher.org/download/).
...
Prism Launcher code is released under [GPL-3.0-only](https://github.com/PrismLauncher/PrismLauncher/blob/develop/LICENSE). The logo and related assets are released under CC BY-SA 4.0.
