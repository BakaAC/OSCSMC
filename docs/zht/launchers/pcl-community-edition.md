...
- 基於 PCL 開放原始碼的社群二次開發版，版本號與主線 PCL 不嚴格對應
- 提供主線暫未製作的功能和改進
- 熟悉的啟動界面
- 資源搜尋與下載頁面
- 實例管理頁面
- 提供穩定版與測試版 Release 通道
- Release 資產附帶 GPG 簽名檔案

## 開源協議

PCL-CE 倉庫根目錄的 [LICENSE](https://github.com/PCL-Community/PCL-CE/blob/dev/LICENSE) 說明：`Plain Craft Launcher 2/` 使用[自訂授權條款](https://github.com/PCL-Community/PCL-CE/blob/dev/Plain%20Craft%20Launcher%202/LICENCE)，其餘所有目錄使用 [Apache License 2.0](https://github.com/PCL-Community/PCL-CE/blob/dev/LICENSE)。
